...
if __name__ == '__main__':
    ...
    task = 'clas'
    ncpu = 4
    PubchemFP881_path = r'C:\Users\Administrator\Desktop\dataset\dataset\预测\PUBCHEM.csv'
    GraphFP1024_path = r'C:\Users\Administrator\Desktop\dataset\dataset\预测\GRAPH.csv'
    APC2D780_path = r'C:\Users\Administrator\Desktop\dataset\dataset\预测\APC2D.csv'
    FP1024_path = r'C:\Users\Administrator\Desktop\dataset\dataset\预测\FP1024.csv'
    ...
    if not os.path.isfile(processed_data_file):
        ...
        for idx, smi in enumerate(compound_iso_smiles):
            smis.append(smi)
            current_fp1 = fp1[idx]
            current_fp2 = fp2[idx]
            current_fp3 = fp3[idx]
        ...
        MolNet_pre(root='./dataset', dataset=moldata+task, xd=smis, smile_graph=smile_graph,
